...
!!-------------------------------------------------------------------------------------------------
 ...
 contains
  !  function gravity_anomaly_classic_first_approximation(N, latitude, longitude, GM, R, GM_ellipsoid, a, b, f_reciprocal, omega, C_bar_nm, nmax, p_bar_nm, dp_bar_nm) result(ddelta_g)
   function ga_classic_first_approximation(N, latitude, longitude, GM, R, GM_ellipsoid, a, b, f_reciprocal, omega, C_bar_nm, nmax, p_bar_nm, dp_bar_nm) result(ddelta_g)
   ...
   end function ga_classic_first_approximation

   function ga_classic_second_approximation(h, N, latitude, longitude, GM, R, GM_ellipsoid, a, b, f_reciprocal, omega, C_bar_nm, nmax, p_bar_nm, dp_bar_nm) result(ddelta_g)
   ...
   end function ga_classic_second_approximation
